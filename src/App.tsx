      ...
      <section className="px-5 py-8 bg-light-gray-3 space-y-5">
        ...
        <div className="flex flex-col justify-center gap-5">
          <div className="bg-[#D8E3F2] p-5 rounded-lg space-y-5 relative shadow-lg">
            ...
            <button
              type="button"
              className="bg-white text-primary font-bold rounded-lg p-3 w-36 relative z-10 hover:bg-light-gray-3 transition-colors"
            >
              Comprar
            </button>
          ...
          <div className="bg-[#D8E3F2] p-5 rounded-lg space-y-5 relative shadow-lg">
            ...
            <button
              type="button"
              className="bg-white text-primary font-bold rounded-lg p-3 w-36 hover:bg-light-gray-3 transition-colors"
            >
              Comprar
            </button>
