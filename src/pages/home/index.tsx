    ...
    <div className="mx-auto w-96">
      ...
      <section className="space-y-5 px-5 py-8">
        ...
        <div className="flex flex-col justify-center gap-8">
          <p className="font-semibold text-warning">Oferta especial</p>

          <h2 className="text-4xl font-semibold text-dark-gray-2">
          ...
          <button
            type="button"
            className="w-48 rounded-lg bg-primary px-4 py-2 font-bold text-light-gray-3 transition-colors hover:bg-tertiary"
          >
            Ver Oferta
          </button>
        </div>
